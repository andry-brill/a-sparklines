...
abstract class BaseLineTypeRenderer<LD extends ILineTypeData> implements ILineTypeRenderer {
  ...
  Paint buildFillPaint(ChartTransform transform, ILineChartData lineData) {
    return Paint()
  ...
  void renderSimplePath(Canvas canvas, ChartTransform transform, ILineChartData lineData) {
  ...
  bool renderDynamicPaint(Canvas canvas, ChartTransform transform, ILineChartData lineData, bool isDynamicStroke, bool isDynamicPaint) {
